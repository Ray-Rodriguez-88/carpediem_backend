...
code_challenge = Event.create(user:rick, name:"code challenge", description:"test", priority: "high", time_start:"10:00", time_end:"11:00")
lunch = Event.create(name:"lunch", user:ray, description:"test", priority: "medium", time_start:"12:00", time_end:"13:00")
